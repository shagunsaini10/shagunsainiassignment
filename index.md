...
6. [Networking â€” WSL2 Host Isolation Issue](#6-networking--wsl2-host-isolation-issue)
...
â”‚                    WSL2 Host (eth0)                      â”‚
â”‚                  172.29.88.107/20                        â”‚
â”‚                                                          â”‚
â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”    â”‚
â”‚  â”‚              Docker Environment                  â”‚    â”‚
â”‚  â”‚                                                  â”‚    â”‚
â”‚  â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”                        â”‚    â”‚
â”‚  â”‚  â”‚   fastapi_backend    â”‚                        â”‚    â”‚
â”‚  â”‚  â”‚  IPvlan: 172.29.80.10â”‚â—„â”€â”€â”€â”€ Client Requests  â”‚    â”‚
â”‚  â”‚  â”‚  Port: 8000          â”‚      (via bridge)      â”‚    â”‚
â”‚  â”‚  â”‚  Image: ~95MB        â”‚                        â”‚    â”‚
â”‚  â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜                        â”‚    â”‚
â”‚  â”‚             â”‚ psycopg2 / port 5432                â”‚    â”‚
â”‚  â”‚  â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”                        â”‚    â”‚
â”‚  â”‚  â”‚    postgres_db        â”‚                        â”‚    â”‚
â”‚  â”‚  â”‚  IPvlan: 172.29.80.11â”‚                        â”‚    â”‚
â”‚  â”‚  â”‚  Named Volume: pgdata â”‚                        â”‚    â”‚
â”‚  â”‚  â”‚  Image: ~75MB         â”‚                        â”‚    â”‚
â”‚  â”‚  â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜                        â”‚    â”‚
â”‚  â”‚                                                  â”‚    â”‚
â”‚  â”‚  Networks:                                       â”‚    â”‚
â”‚  â”‚  â”œâ”€â”€ ipvlan_net  (external, L2, eth0 parent)     â”‚    â”‚
â”‚  â”‚  â””â”€â”€ internal_bridge (bridge, host port binding) â”‚    â”‚
...
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”     IPvlan L2      â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ fastapi_back â”‚â—„â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–ºâ”‚   postgres_db   â”‚
â”‚ 172.29.80.10 â”‚                    â”‚  172.29.80.11   â”‚
...
### Multi-Stage Build â€” Backend (FastAPI)
...
USER appuser
```
Security best practice â€” process runs with minimal OS privileges.
...
**5. Layer ordering â€” dependencies before code**
```dockerfile
COPY requirements.txt .          # Changes rarely â†’ cached
RUN pip install ...              # Heavy step â€” cached after first build
COPY main.py .                   # Changes often â†’ only this layer rebuilds
```
Docker caches layers from top to bottom. Placing stable files first maximizes cache reuse.

**6. `--prefix=/install` trick**
Installs Python packages to a custom prefix directory, making it trivial to `COPY --from=builder /install /usr/local` in the runtime stage â€” a clean surgical transfer of only the installed packages.
...
- Reduced attack surface â€” fewer packages means fewer CVEs
...
IPvlan has the same WSL2 host isolation behavior â€” see Section 6 for details.

---

## 6. Networking â€” WSL2 Host Isolation Issue
...
- `ipvlan_net` â†’ satisfies the assignment requirement, containers have static LAN IPs
- `internal_bridge` + `ports: 8000:8000` â†’ enables `localhost:8000` access from WSL2 host
...
# â†’ {"id":1,"name":"test","value":"hello world"}
...
curl http://localhost:8000/records
# â†’ [{"id":1,...},{"id":2,...}]  â† data survived restart âœ“
```
...
â”œâ”€â”€ database/
â”‚   â”œâ”€â”€ Dockerfile          # Custom postgres:15-alpine image
â”‚   â””â”€â”€ .dockerignore
...
*Report prepared for Project Assignment 1 â€” Docker Containerization & Networking*
